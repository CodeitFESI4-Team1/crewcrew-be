        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers(HttpMethod.POST, "/api/crews")
                    ...
                    .authenticated()
                    .requestMatchers(HttpMethod.DELETE, "/api/crews/*/gatherings/*/leave")
                    .authenticated()
                    .requestMatchers(HttpMethod.DELETE, "/api/crews/*/gatherings/*")
                    .authenticated()
                    .requestMatchers(HttpMethod.GET, "/api/gatherings/hosted")
                    .authenticated()
                    .requestMatchers(HttpMethod.GET, "/api/gatherings/joined")
                    .authenticated()
                    .requestMatchers(HttpMethod.GET, "/api/gatherings/reviewable")
                    .authenticated()
